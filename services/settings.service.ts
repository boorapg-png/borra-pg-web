...
const defaultSettings: GlobalSettings = {
  ...
  rateHistory: [] as any[], // Explicitly typed to prevent 'implicit any' errors
  noticePeriodDays: 30,
  gracePeriodDays: 7,
...
export const settingsService = {
  ...
  updateElectricityRate: async (newRate: number): Promise<void> => {
    ...
    // Safely ensure history is an array before trying to spread it
    const currentHistory = Array.isArray(currentData.rateHistory) ? currentData.rateHistory : [];
